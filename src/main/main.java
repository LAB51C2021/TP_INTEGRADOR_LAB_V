...
public class main {
	...
	public static void main(String[] args) {
		...
		hibernateConnector.AddEntity(new Usuario("Luciano", "Luciano@hotmail.com.ar", "123", 
				new Persona("Luciano Rodriguez", "34215555", "M", LocalDate.now(), "Av. Alere 2154", "Los Troncos", 1, 1, false, true), true, CuentaList));
		...
		hibernateConnector.AddEntity(new Usuario("MaxMatiasGonzales", "Max@hotmail.com.ar", "123", 
				new Persona("Matias Gonzales", "42545321", "M", LocalDate.now(), "Martinez 1322", "Tigre", 1, 1, false, true), true, CuentaList));
		...
		hibernateConnector.AddEntity(new Usuario("Franco", "Fran@hotmail.com.ar", "123",
				new Persona("Franco Alvarez", "35566213", "M", LocalDate.now(), "Larte 1122", "Tigre", 1, 1, false, true), true, CuentaList));
		...
		hibernateConnector.AddEntity(new Usuario("Diego", "Diego@hotmail.com.ar", "123", 
				new Persona("Diego Britez", "35235554", "M", LocalDate.now(), "Acceso 1245", "Tigre", 1, 1, false, true), true, CuentaList));
